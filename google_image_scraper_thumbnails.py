...
# if (not sys.argv[1]) or (sys.argv[1] == ''): SystemExit('Input query string for google search.')

# search_query = sys.argv[1]
get_request = 'https://www.google.com/search?tbm=isch&q=impact+font+memes' # + search_query.replace(' ', '+')
...
image_counter = 354
for img in wd.find_elements_by_css_selector('img.rg_i')[354::]:
    if img.is_displayed(): image_counter = process_image_whole(img, image_counter)
